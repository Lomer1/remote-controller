...
final class ConnectionManager {
    ...
    func send(_ command: RemoteCommand) {
        ...
        // После команд громкости/яркости/mute — запрашиваем актуальные значения
    ...
    private func parseSystemInfo(_ data: Data) {
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            self.logger.info("SystemInfo: volume=\(self.currentVolume), brightness=\(self.currentBrightness)")
        }
    }
